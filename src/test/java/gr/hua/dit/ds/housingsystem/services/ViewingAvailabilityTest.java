...
public class ViewingAvailabilityTest {
    ...
    public void testViewingAvailability() {
        ...
        owner.setIdFrontPath("path/to/front-id.jpg");
        owner.setIdBackPath("path/to/back-id.jpg");
        ...
        // Create and save Availability Slots
        ...
        // Verify slots are saved and associated with the property
        List<AvailabilitySlot> slots = availabilitySlotRepository.findAllByPropertyId(savedProperty.getId());
