...
public class SecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(userDetailsServiceImpl); // Use the injected userDetailsServiceImpl
        authProvider.setPasswordEncoder(passwordEncoder()); // Ensure a password encoder is available
        return authProvider;
    }
